...
def check_all_classes_covered(classes, extended_node_pairs, hostnames):
...
class Predictor():
    ...
    def __init__(self, classes, extended_node_pairs, test_results):
        ...
        check_all_classes_covered(self.classes, extended_node_pairs, test_results.hostnames)
...
def main():
    ...
    predictor = Predictor(classes, extended_node_pairs, test_results)
